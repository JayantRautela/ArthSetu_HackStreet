...
import { getConversationHistory, addMessageToConversation } from "./conversationStore.js";
...
export async function handleStreamingChat(conversationId: string, userMessage: string, res: any) {
  try {
